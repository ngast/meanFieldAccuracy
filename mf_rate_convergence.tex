...
\acmConference[SIGMETRICS'17]{ACM SIGMETRICS conference}{June 6-8,
  2017}{Champaign-Urbana, USA}
\acmISBN{}
\acmDOI{}
\acmPrice{}
...
\begin{figure}[ht]
  ...
  \begin{tabular}[ht]{@{}c@{}c@{}}
    (a)&\begin{tabular}{@{}c}\includegraphics[width=.9\linewidth]{jsq2_simulate/C_rho}
        \end{tabular}\\
    (b)&\begin{tabular}{@{}c}\includegraphics[width=.9\linewidth]{jsq2_simulate/C_rho_conv}
        \end{tabular}
  \end{tabular}
...
\sum_{i=1}^\infty(w_j-w_i)\sum_{j=i}^\infty\XtN_j =\norm{\XtN}_w
$.
